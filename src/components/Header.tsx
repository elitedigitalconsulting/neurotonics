        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 sm:h-18">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-brand-primary to-brand-warm flex items-center justify-center">
            ...
            <div className="flex items-center space-x-4">
              {/* Search Icon */}
              <Link href="/product" className="hidden sm:block text-gray-600 hover:text-brand-primary transition-colors">
